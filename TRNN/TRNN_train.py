...
# 5 classes
# data_dir = {'train': ('../swc_data/swc_v1/train/interneuron', '../swc_data/swc_v1/train/principal cell/pyramidal', '../swc_data/swc_v1/train/Glia', '../swc_data/swc_v1/train/Not reported', '../swc_data/swc_v1/train/sensory receptor'),
#             'test': ('../swc_data/swc_v1/test/interneuron', '../swc_data/swc_v1/test/principal cell/pyramidal', '../swc_data/swc_v1/test/Glia', '../swc_data/swc_v1/test/Not reported', '../swc_data/swc_v1/test/sensory receptor')}

# 12 classes: all classes more than 300
data_dir = {'train':
                ('../swc_data/swc_v1/train/principal cell/ganglion', '../swc_data/swc_v1/train/principal cell/pyramidal',
                '../swc_data/swc_v1/train/principal cell/Purkinje', '../swc_data/swc_v1/train/principal cell/granule',
                '../swc_data/swc_v1/train/principal cell/medium spiny', '../swc_data/swc_v1/train/interneuron/Nitrergic',
                '../swc_data/swc_v1/train/interneuron/GABAergic', '../swc_data/swc_v1/train/Glia/microglia',
                '../swc_data/swc_v1/train/principal cell/Parachromaffin', '../swc_data/swc_v1/train/interneuron/basket',
                '../swc_data/swc_v1/train/Glia/astrocyte', '../swc_data/swc_v1/train/sensory receptor'),
            'test':
                ('../swc_data/swc_v1/test/principal cell/ganglion', '../swc_data/swc_v1/test/principal cell/pyramidal',
                '../swc_data/swc_v1/test/principal cell/Purkinje', '../swc_data/swc_v1/test/principal cell/granule',
                '../swc_data/swc_v1/test/principal cell/medium spiny', '../swc_data/swc_v1/test/interneuron/Nitrergic',
                '../swc_data/swc_v1/test/interneuron/GABAergic', '../swc_data/swc_v1/test/Glia/microglia',
                '../swc_data/swc_v1/test/principal cell/Parachromaffin', '../swc_data/swc_v1/test/interneuron/basket',
                '../swc_data/swc_v1/test/Glia/astrocyte', '../swc_data/swc_v1/test/sensory receptor')
            }
...
maxlen_of_tree = 300
trained = False
model_filename = 'model_12class(v1)'
